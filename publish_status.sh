...
if ! git diff --quiet -- status.json injury-report/data nba-daily-games/data stocks/data weather-reports/data; then
  git add status.json injury-report/data nba-daily-games/data stocks/data weather-reports/data
